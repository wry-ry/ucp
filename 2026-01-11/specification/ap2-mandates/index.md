...
| ap2          | [Ap2 Checkout Response](/2026-01-11/specification/ap2-mandates/#ap2-checkout-response) | No       | AP2 extension data including merchant authorization.                                                                                                                                                                                                            |
...
| Name | Type                                                                                 | Required | Description                                    |
| ---- | ------------------------------------------------------------------------------------ | -------- | ---------------------------------------------- |
| ap2  | [Ap2 Complete Request](/2026-01-11/specification/ap2-mandates/#ap2-complete-request) | No       | AP2 extension data including checkout mandate. |
...
| Name                   | Type                                                                                     | Required | Description                                                |
| ---------------------- | ---------------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------- |
| merchant_authorization | [Merchant Authorization](/2026-01-11/specification/ap2-mandates/#merchant-authorization) | **Yes**  | Merchant's signature proving checkout terms are authentic. |
...
| Name             | Type                                                                         | Required | Description                                      |
| ---------------- | ---------------------------------------------------------------------------- | -------- | ------------------------------------------------ |
| checkout_mandate | [Checkout Mandate](/2026-01-11/specification/ap2-mandates/#checkout-mandate) | **Yes**  | SD-JWT+kb proving user authorized this checkout. |
