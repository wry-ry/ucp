...
> **Note:** Checkout permalinks are a REST-specific construct that extends the [REST transport binding](https://wry-ry.github.io/ucp/2026-01-11/specification/checkout-rest/index.md). Accessing a permalink returns a redirect to the checkout UI or renders the checkout page directly.
...
| ------------ | ----------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Checkout](/ucp/2026-01-11/specification/checkout/#ucp-response-checkout)    | **Yes**  |                                                                                                                                                                                                                                                                 |
| id           | string                                                                                    | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
| line_items   | Array\[[Line Item Response](/ucp/2026-01-11/specification/checkout/#line-item-response)\] | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
| buyer        | [Buyer](/ucp/2026-01-11/specification/checkout/#buyer)                                    | No       | Representation of the buyer.                                                                                                                                                                                                                                    |
...
| totals       | Array\[[Total Response](/ucp/2026-01-11/specification/checkout/#total-response)\]         | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
| messages     | Array\[[Message](/ucp/2026-01-11/specification/checkout/#message)\]                       | No       | List of messages with error and info about the checkout session state.                                                                                                                                                                                          |
| links        | Array\[[Link](/ucp/2026-01-11/specification/checkout/#link)\]                             | **Yes**  | Links to be displayed by the platform (Privacy Policy, TOS). Mandatory for legal compliance.                                                                                                                                                                    |
...
| payment      | [Payment Response](/ucp/2026-01-11/specification/checkout/#payment-response)              | **Yes**  |                                                                                                                                                                                                                                                                 |
| order        | [Order Confirmation](/ucp/2026-01-11/specification/checkout/#order-confirmation)          | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
...
| Name       | Type                                                                                                  | Required | Description                           |
| ---------- | ----------------------------------------------------------------------------------------------------- | -------- | ------------------------------------- |
| line_items | Array\[[Line Item Create Request](/ucp/2026-01-11/specification/checkout/#line-item-create-request)\] | **Yes**  | List of line items being checked out. |
| buyer      | [Buyer](/ucp/2026-01-11/specification/checkout/#buyer)                                                | No       | Representation of the buyer.          |
| currency   | string                                                                                                | **Yes**  | ISO 4217 currency code.               |
| payment    | [Payment Create Request](/ucp/2026-01-11/specification/checkout/#payment-create-request)              | **Yes**  |                                       |
...
| id         | string                                                                                                | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| id         | string                                                                                                | **Yes**  | Unique identifier of the checkout session.                     |
| line_items | Array\[[Line Item Update Request](/ucp/2026-01-11/specification/checkout/#line-item-update-request)\] | **Yes**  | List of line items being checked out.                          |
| buyer      | [Buyer](/ucp/2026-01-11/specification/checkout/#buyer)                                                | No       | Representation of the buyer.                                   |
| currency   | string                                                                                                | **Yes**  | ISO 4217 currency code.                                        |
| payment    | [Payment Update Request](/ucp/2026-01-11/specification/checkout/#payment-update-request)              | **Yes**  |                                                                |
...
| ------------ | -------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------- |
| id           | string                                                                           | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| payment_data | [Payment Instrument](/ucp/2026-01-11/specification/checkout/#payment-instrument) | **Yes**  |                                                                |
...
- [REST Binding](https://wry-ry.github.io/ucp/2026-01-11/specification/checkout-rest/index.md): RESTful API mapping using standard HTTP verbs and JSON payloads.
- [MCP Binding](https://wry-ry.github.io/ucp/2026-01-11/specification/checkout-mcp/index.md): Model Context Protocol mapping for agentic interaction.
- [A2A Binding](https://wry-ry.github.io/ucp/2026-01-11/specification/checkout-a2a/index.md): Agent-to-Agent Protocol mapping for agentic interactions.
- [Embedded Checkout Binding](https://wry-ry.github.io/ucp/2026-01-11/specification/embedded-checkout/index.md): JSON-RPC for powering embedded checkout.
...
| totals                    | Array\[[Total Response](/ucp/2026-01-11/specification/checkout/#total-response)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| Name     | Type                                                                               | Required | Description                           |
| -------- | ---------------------------------------------------------------------------------- | -------- | ------------------------------------- |
| item     | [Item Create Request](/ucp/2026-01-11/specification/checkout/#item-create-request) | **Yes**  |                                       |
...
| --------- | ---------------------------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                                             | No       |                                                        |
| item      | [Item Update Request](/ucp/2026-01-11/specification/checkout/#item-update-request) | **Yes**  |                                                        |
| quantity  | integer                                                                            | **Yes**  | Quantity of the item being purchased.                  |
...
| --------- | --------------------------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                                            | **Yes**  |                                                        |
| item      | [Item Response](/ucp/2026-01-11/specification/checkout/#item-response)            | **Yes**  |                                                        |
| quantity  | integer                                                                           | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total Response](/ucp/2026-01-11/specification/checkout/#total-response)\] | **Yes**  | Line item totals breakdown.                            |
| parent_id | string                                                                            | No       | Parent line item identifier for any nested structures. |
...
This object MUST be one of the following types: [Message Error](/ucp/2026-01-11/specification/checkout/#message-error), [Message Warning](/ucp/2026-01-11/specification/checkout/#message-warning), [Message Info](/ucp/2026-01-11/specification/checkout/#message-info).
...
| Name                   | Type                                                                                                  | Required | Description                                                                                                                                                                                                                |
| ---------------------- | ----------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| handlers               | Array\[[Payment Handler Response](/ucp/2026-01-11/specification/checkout/#payment-handler-response)\] | **Yes**  | Processing configurations that define how payment instruments can be collected. Each handler specifies a tokenization or payment collection strategy.                                                                      |
| selected_instrument_id | string                                                                                                | No       | The id of the currently selected payment instrument from the instruments array. Set by the agent when submitting payment, and echoed back by the merchant in finalized state.                                              |
| instruments            | Array\[[Payment Instrument](/ucp/2026-01-11/specification/checkout/#payment-instrument)\]             | No       | The payment instruments available for this payment. Each instrument is associated with a specific handler via the handler_id field. Handlers can extend the base payment_instrument schema to add handler-specific fields. |
...
This object MUST be one of the following types: [Card Payment Instrument](/ucp/2026-01-11/specification/checkout/#card-payment-instrument).
...
| billing_address       | [Postal Address](/ucp/2026-01-11/specification/checkout/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                           |
| credential            | [Payment Credential](/ucp/2026-01-11/specification/checkout/#payment-credential) | No       |                                                                                                                                                                    |
...
This object MUST be one of the following types: [Token Credential Response](/ucp/2026-01-11/specification/checkout/#token-credential-response), [Card Credential](/ucp/2026-01-11/specification/checkout/#card-credential).
...
| capabilities | Array\[[Response](/ucp/2026-01-11/specification/checkout/#response)\] | **Yes**  | Active capabilities for this response.     |
