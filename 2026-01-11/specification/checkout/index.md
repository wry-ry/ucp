...
*RuntimeError*: Error processing OpenAPI: [Errno 2] No such file or directory: 'source/services/shopping/rest.openapi.json' (in file: specification/checkout.md)
...
Traceback (most recent call last):
  ...
  File "<template>", line 296, in top-level template code
