...
| ------------ | ----------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Checkout](/ucp/2026-01-11/specification/checkout/#ucp-response-checkout)    | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                                                                                                                                         |
...
| payment      | [Payment](/ucp/2026-01-11/specification/checkout/#payment)                                | **Yes**  | Payment configuration containing handlers.                                                                                                                                                                                                                      |
...
| Name       | Type                                                                    | Required | Description                                |
| ---------- | ----------------------------------------------------------------------- | -------- | ------------------------------------------ |
| line_items | Array\[[Line Item](/ucp/2026-01-11/specification/checkout/#line-item)\] | **Yes**  | List of line items being checked out.      |
| buyer      | [Buyer](/ucp/2026-01-11/specification/checkout/#buyer)                  | No       | Representation of the buyer.               |
| currency   | string                                                                  | **Yes**  | ISO 4217 currency code.                    |
| payment    | [Payment](/ucp/2026-01-11/specification/checkout/#payment)              | **Yes**  | Payment configuration containing handlers. |
...
| ------------ | -------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------- |
| id           | string                                                                           | **Yes**  | The unique identifier of the checkout session.Defined in path. |
| payment_data | [Payment Instrument](/ucp/2026-01-11/specification/checkout/#payment-instrument) | **Yes**  | Matches a specific instrument type based on validation logic.  |
...
| Name     | Type                                                 | Required | Description                           |
| -------- | ---------------------------------------------------- | -------- | ------------------------------------- |
| item     | [Item](/ucp/2026-01-11/specification/checkout/#item) | **Yes**  |                                       |
...
| item      | [Item](/ucp/2026-01-11/specification/checkout/#item)            | **Yes**  |                                                        |
| quantity  | integer                                                         | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/ucp/2026-01-11/specification/checkout/#total)\] | **Yes**  | Line item totals breakdown.                            |
| parent_id | string                                                          | No       | Parent line item identifier for any nested structures. |
...
| credential            | [Payment Credential](/ucp/2026-01-11/specification/checkout/#payment-credential) | No       | Container for sensitive payment data. Use the specific schema matching the 'type' field.                                                                           |
...
This object MUST be one of the following types: [Token Credential](/ucp/2026-01-11/specification/checkout/#token-credential), [Card Credential](/ucp/2026-01-11/specification/checkout/#card-credential).
