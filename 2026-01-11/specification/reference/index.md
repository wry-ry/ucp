...
| ------------ | --------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Checkout](/ucp/2026-01-11/specification/reference/#ucp-response-checkout) | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                                                                                                                                         |
| id           | string                                                                                  | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
| line_items   | Array\[[Line Item](/ucp/2026-01-11/specification/reference/#line-item)\]                | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
...
| totals       | Array\[[Total](/ucp/2026-01-11/specification/reference/#total)\]                        | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
...
| payment      | [Payment](/ucp/2026-01-11/specification/reference/#payment)                             | **Yes**  | Payment configuration containing handlers.                                                                                                                                                                                                                      |
...
| Name          | Type                                                                                 | Required | Description                                                                                                                                  |
| ------------- | ------------------------------------------------------------------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [UCP Response Order](/ucp/2026-01-11/specification/reference/#ucp-response-order)    | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                      |
...
| totals        | Array\[[Total](/ucp/2026-01-11/specification/reference/#total)\]                     | **Yes**  | Different totals for the order.                                                                                                              |
...
| Name                   | Type                                                                                       | Required | Description                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| handlers               | Array\[[Payment Handler](/ucp/2026-01-11/specification/reference/#payment-handler)\]       | **Yes**  | Processing configurations that define how payment instruments can be collected. Each handler specifies a tokenization or payment collection strategy.                                                                      |
...
| Name         | Type                                                                              | Required | Description                                                   |
| ------------ | --------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------- |
| payment_data | [Payment Instrument](/ucp/2026-01-11/specification/reference/#payment-instrument) | **Yes**  | Matches a specific instrument type based on validation logic. |
...
| credential            | [Payment Credential](/ucp/2026-01-11/specification/reference/#payment-credential) | No       | Container for sensitive payment data. Use the specific schema matching the 'type' field.                                                                           |
...
| Name              | Type                                                                                                           | Required | Description                         |
| ----------------- | -------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method](/ucp/2026-01-11/specification/reference/#fulfillment-method)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method](/ucp/2026-01-11/specification/reference/#fulfillment-available-method)\] | No       | Inventory availability hints.       |
...
This object MUST be one of the following types: [Shipping Destination](/ucp/2026-01-11/specification/reference/#shipping-destination), [Retail Location](/ucp/2026-01-11/specification/reference/#retail-location).
...
| options            | Array\[[Fulfillment Option](/ucp/2026-01-11/specification/reference/#fulfillment-option)\] | No       | Available fulfillment options for this group.                          |
...
| destinations            | Array\[[Fulfillment Destination](/ucp/2026-01-11/specification/reference/#fulfillment-destination)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                   | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group](/ucp/2026-01-11/specification/reference/#fulfillment-group)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| totals                    | Array\[[Total](/ucp/2026-01-11/specification/reference/#total)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| --------- | ---------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                           | **Yes**  |                                                        |
| item      | [Item](/ucp/2026-01-11/specification/reference/#item)            | **Yes**  |                                                        |
| quantity  | integer                                                          | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/ucp/2026-01-11/specification/reference/#total)\] | **Yes**  | Line item totals breakdown.                            |
...
| item      | [Item](/ucp/2026-01-11/specification/reference/#item)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
...
This object MUST be one of the following types: [Token Credential](/ucp/2026-01-11/specification/reference/#token-credential), [Card Credential](/ucp/2026-01-11/specification/reference/#card-credential).
