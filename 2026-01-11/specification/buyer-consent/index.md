...
*File*: `specification/buyer-consent.md`

*FileNotFoundError*: Schema file 'buyer_consent_resp.json' not found in any schema directory (in file: specification/buyer-consent.md).
