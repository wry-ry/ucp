...
| ----------- | ------------------------------------------------------ | -------- | -------------------- |
| fulfillment | [Fulfillment](/specification/fulfillment/#fulfillment) | No       | Fulfillment details. |
...
| Name              | Type                                                                                                                | Required | Description                         |
| ----------------- | ------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method Response](/specification/fulfillment/#fulfillment-method-response)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method Response](/specification/fulfillment/#fulfillment-available-method-response)\] | No       | Inventory availability hints.       |
...
| destinations            | Array\[[Fulfillment Destination Response](/specification/fulfillment/#fulfillment-destination-response)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                        | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group Response](/specification/fulfillment/#fulfillment-group-response)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |

#### Fulfillment Destination Response

This object MUST be one of the following types: [Shipping Destination Response](/specification/fulfillment/#shipping-destination-response), [Retail Location Response](/specification/fulfillment/#retail-location-response).
...
| address | [Postal Address](/specification/fulfillment/#postal-address) | No       | Physical address of the location. |
...
| options            | Array\[[Fulfillment Option Response](/specification/fulfillment/#fulfillment-option-response)\] | No       | Available fulfillment options for this group.                          |
...
| totals                    | Array\[[Total Response](/specification/fulfillment/#total-response)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
