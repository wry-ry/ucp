...
This document specifies the Model Context Protocol (MCP) binding for the [Cart Capability](https://wry-ry.github.io/ucp/draft/specification/cart/index.md).
...
| ------------- | --------------------------------------------------------------------------------- | ---------------------- |
| `create_cart` | [Create Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#create-cart) | Create a cart session. |
| `get_cart`    | [Get Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#get-cart)       | Get a cart session.    |
| `update_cart` | [Update Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#update-cart) | Update a cart session. |
| `cancel_cart` | [Cancel Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#cancel-cart) | Cancel a cart session. |

### `create_cart`

Maps to the [Create Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#create-cart) operation.
...
Maps to the [Get Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#get-cart) operation.
...
Maps to the [Update Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#update-cart) operation.
...
Maps to the [Cancel Cart](https://wry-ry.github.io/ucp/draft/specification/cart/#cancel-cart) operation.
