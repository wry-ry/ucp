...
| line_items   | Array\[[Line Item Response](/ucp/draft/specification/checkout/#line-item)\]                     | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
...
| totals       | Array\[[Total Response](/ucp/draft/specification/checkout/#total)\]                             | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
...
This object MUST be one of the following types: [Checkout](/ucp/draft/specification/checkout/#checkout), [Error Response](/ucp/draft/specification/checkout/#error-response).
...
| messages     | Array\[[Message](/ucp/draft/specification/checkout/#message)\] | **Yes**  | Array of messages describing why the operation failed.            |
