...
| ---------- | ------------------------------------------------------------------------------------------------- | -------- | ------------------------------------- |
| line_items | Array\[[Line Item Create Request](/ucp/draft/specification/reference/#line-item-create-request)\] | **Yes**  | List of line items being checked out. |
| buyer      | [Buyer](/ucp/draft/specification/reference/#buyer)                                                | No       | Representation of the buyer.          |
| currency   | string                                                                                            | **Yes**  | ISO 4217 currency code.               |
| payment    | [Payment Create Request](/ucp/draft/specification/reference/#payment-create-request)              | **Yes**  |                                       |
...
| line_items | Array\[[Line Item Update Request](/ucp/draft/specification/reference/#line-item-update-request)\] | **Yes**  | List of line items being checked out.      |
| buyer      | [Buyer](/ucp/draft/specification/reference/#buyer)                                                | No       | Representation of the buyer.               |
| currency   | string                                                                                            | **Yes**  | ISO 4217 currency code.                    |
| payment    | [Payment Update Request](/ucp/draft/specification/reference/#payment-update-request)              | **Yes**  |                                            |
...
| Name         | Type                                                                                  | Required | Description                                                                                                                                                                                                                                                     |
| ------------ | ------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Checkout](/ucp/draft/specification/reference/#ucp-response-checkout)    | **Yes**  |                                                                                                                                                                                                                                                                 |
| id           | string                                                                                | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
| line_items   | Array\[[Line Item Response](/ucp/draft/specification/reference/#line-item-response)\] | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
| buyer        | [Buyer](/ucp/draft/specification/reference/#buyer)                                    | No       | Representation of the buyer.                                                                                                                                                                                                                                    |
...
| currency     | string                                                                                | **Yes**  | ISO 4217 currency code.                                                                                                                                                                                                                                         |
| totals       | Array\[[Total Response](/ucp/draft/specification/reference/#total-response)\]         | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
...
| payment      | [Payment Response](/ucp/draft/specification/reference/#payment-response)              | **Yes**  |                                                                                                                                                                                                                                                                 |
...
| Name          | Type                                                                            | Required | Description                                                                                                                                  |
| ------------- | ------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [UCP Response Order](/ucp/draft/specification/reference/#ucp-response-order)    | **Yes**  |                                                                                                                                              |
...
| totals        | Array\[[Total Response](/ucp/draft/specification/reference/#total-response)\]   | **Yes**  | Different totals for the order.                                                                                                              |
...
| Name         | Type                                                                         | Required | Description |
| ------------ | ---------------------------------------------------------------------------- | -------- | ----------- |
| payment_data | [Payment Instrument](/ucp/draft/specification/reference/#payment-instrument) | **Yes**  |             |
...
| Name                   | Type                                                                                              | Required | Description                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| handlers               | Array\[[Payment Handler Response](/ucp/draft/specification/reference/#payment-handler-response)\] | **Yes**  | Processing configurations that define how payment instruments can be collected. Each handler specifies a tokenization or payment collection strategy.                                                                      |
| selected_instrument_id | string                                                                                            | No       | The id of the currently selected payment instrument from the instruments array. Set by the agent when submitting payment, and echoed back by the merchant in finalized state.                                              |
| instruments            | Array\[[Payment Instrument](/ucp/draft/specification/reference/#payment-instrument)\]             | No       | The payment instruments available for this payment. Each instrument is associated with a specific handler via the handler_id field. Handlers can extend the base payment_instrument schema to add handler-specific fields. |
...
| credential            | [Payment Credential](/ucp/draft/specification/reference/#payment-credential) | No       |                                                                                                                                                                    |
...
This object MUST be one of the following types: [Shipping Destination Request](/ucp/draft/specification/reference/#shipping-destination-request), [Retail Location Request](/ucp/draft/specification/reference/#retail-location-request).

______________________________________________________________________

### Fulfillment Destination Response

This object MUST be one of the following types: [Shipping Destination Response](/ucp/draft/specification/reference/#shipping-destination-response), [Retail Location Response](/ucp/draft/specification/reference/#retail-location-response).
...
| options            | Array\[[Fulfillment Option Response](/ucp/draft/specification/reference/#fulfillment-option-response)\] | No       | Available fulfillment options for this group.                          |
| selected_option_id | ['string', 'null']                                                                                      | No       | ID of the selected fulfillment option for this group.                  |
...
| destinations            | Array\[[Fulfillment Destination Request](/ucp/draft/specification/reference/#fulfillment-destination-request)\]   | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                                | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group Create Request](/ucp/draft/specification/reference/#fulfillment-group-create-request)\] | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| destinations            | Array\[[Fulfillment Destination Request](/ucp/draft/specification/reference/#fulfillment-destination-request)\]   | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                                | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group Update Request](/ucp/draft/specification/reference/#fulfillment-group-update-request)\] | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| type                    | string                                                                                                            | **Yes**  | Fulfillment method type. **Enum:** `shipping`, `pickup`                                                      |
| line_item_ids           | Array[string]                                                                                                     | **Yes**  | Line item IDs fulfilled via this method.                                                                     |
| destinations            | Array\[[Fulfillment Destination Response](/ucp/draft/specification/reference/#fulfillment-destination-response)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                                | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group Response](/ucp/draft/specification/reference/#fulfillment-group-response)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| totals                    | Array\[[Total Response](/ucp/draft/specification/reference/#total-response)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| Name    | Type                                                                                                                | Required | Description                         |
| ------- | ------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods | Array\[[Fulfillment Method Create Request](/ucp/draft/specification/reference/#fulfillment-method-create-request)\] | No       | Fulfillment methods for cart items. |
...
| Name              | Type                                                                                                                        | Required | Description                         |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method Response](/ucp/draft/specification/reference/#fulfillment-method-response)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method Response](/ucp/draft/specification/reference/#fulfillment-available-method-response)\] | No       | Inventory availability hints.       |
...
| Name     | Type                                                                           | Required | Description                           |
| -------- | ------------------------------------------------------------------------------ | -------- | ------------------------------------- |
| item     | [Item Create Request](/ucp/draft/specification/reference/#item-create-request) | **Yes**  |                                       |
...
| --------- | ------------------------------------------------------------------------------ | -------- | ------------------------------------------------------ |
| id        | string                                                                         | No       |                                                        |
| item      | [Item Update Request](/ucp/draft/specification/reference/#item-update-request) | **Yes**  |                                                        |
| quantity  | integer                                                                        | **Yes**  | Quantity of the item being purchased.                  |
...
| --------- | ----------------------------------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                                                        | **Yes**  |                                                        |
| item      | [Item Response](/ucp/draft/specification/reference/#item-response)            | **Yes**  |                                                        |
| quantity  | integer                                                                       | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total Response](/ucp/draft/specification/reference/#total-response)\] | **Yes**  | Line item totals breakdown.                            |
| parent_id | string                                                                        | No       | Parent line item identifier for any nested structures. |
...
| item      | [Item Response](/ucp/draft/specification/reference/#item-response)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
...
This object MUST be one of the following types: [Token Credential Response](/ucp/draft/specification/reference/#token-credential-response), [Card Credential](/ucp/draft/specification/reference/#card-credential).
...
This object MUST be one of the following types: [Card Payment Instrument](/ucp/draft/specification/reference/#card-payment-instrument).
...
| Name                   | Type                                                                                 | Required | Description                                                |
| ---------------------- | ------------------------------------------------------------------------------------ | -------- | ---------------------------------------------------------- |
| merchant_authorization | [Merchant Authorization](/ucp/draft/specification/reference/#merchant-authorization) | **Yes**  | Merchant's signature proving checkout terms are authentic. |

#### AP2 Complete Request Object

| Name             | Type                                                                     | Required | Description                                      |
| ---------------- | ------------------------------------------------------------------------ | -------- | ------------------------------------------------ |
| checkout_mandate | [Checkout Mandate](/ucp/draft/specification/reference/#checkout-mandate) | **Yes**  | SD-JWT+kb proving user authorized this checkout. |
...
| payment      | [Payment Response](/ucp/draft/specification/reference/#payment-response)              | **Yes**  |                                                                                                                                                                                                                                                                 |
| order        | [Order Confirmation](/ucp/draft/specification/reference/#order-confirmation)          | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
| ap2          | [Ap2 Checkout Response](/ucp/draft/specification/reference/#ap2-checkout-response)    | No       | AP2 extension data including merchant authorization.                                                                                                                                                                                                            |

#### Complete Checkout Request with AP2

| Name | Type                                                                             | Required | Description                                    |
| ---- | -------------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| ap2  | [Ap2 Complete Request](/ucp/draft/specification/reference/#ap2-complete-request) | No       | AP2 extension data including checkout mandate. |
...
| email        | string                                                 | No       | Email of the buyer.                                                                               |
| phone_number | string                                                 | No       | E.164 standard.                                                                                   |
| consent      | [Consent](/ucp/draft/specification/reference/#consent) | No       | Consent tracking fields.                                                                          |
...
| ---------- | ------------------------------------------------------------------------------------------------- | -------- | ------------------------------------- |
| line_items | Array\[[Line Item Create Request](/ucp/draft/specification/reference/#line-item-create-request)\] | **Yes**  | List of line items being checked out. |
| buyer      | [Buyer](/ucp/draft/specification/reference/#buyer)                                                | No       | Buyer with consent tracking.          |
| currency   | string                                                                                            | **Yes**  | ISO 4217 currency code.               |
| payment    | [Payment Create Request](/ucp/draft/specification/reference/#payment-create-request)              | **Yes**  |                                       |
...
| allocations | Array\[[Allocation](/ucp/draft/specification/reference/#allocation)\] | No       | Breakdown of where this discount was allocated. Sum of allocation amounts equals total amount.                                   |
...
| applied | Array\[[Applied Discount](/ucp/draft/specification/reference/#applied-discount)\] | No       | Discounts successfully applied (code-based and automatic).                                                 |
...
| currency   | string                                                                                            | **Yes**  | ISO 4217 currency code.               |
| payment    | [Payment Create Request](/ucp/draft/specification/reference/#payment-create-request)              | **Yes**  |                                       |
| discounts  | [Discounts Object](/ucp/draft/specification/reference/#discounts-object)                          | No       |                                       |
...
| currency    | string                                                                                            | **Yes**  | ISO 4217 currency code.               |
| payment     | [Payment Create Request](/ucp/draft/specification/reference/#payment-create-request)              | **Yes**  |                                       |
| fulfillment | [Fulfillment](/ucp/draft/specification/reference/#fulfillment)                                    | No       | Fulfillment details.                  |
...
| services     | [Services](/ucp/draft/specification/reference/#services)            | **Yes**  |                                            |
| capabilities | Array\[[Discovery](/ucp/draft/specification/reference/#discovery)\] | **Yes**  | Supported capabilities and extensions.     |
...
| ------------ | ----------------------------------------------------------------- | -------- | ------------------------------------------ |
| version      | string                                                            | **Yes**  | UCP protocol version in YYYY-MM-DD format. |
| capabilities | Array\[[Response](/ucp/draft/specification/reference/#response)\] | **Yes**  | Active capabilities for this response.     |
