...
*RuntimeError*: Failed to resolve '' (in file: specification/order.md). Ensure ucp-schema is installed: `cargo install ucp-schema`
...
Traceback (most recent call last):
  ...
  File "<template>", line 354, in top-level template code
