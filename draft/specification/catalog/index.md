...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [`dev.ucp.shopping.catalog.search`](https://wry-ry.github.io/ucp/draft/specification/catalog/search/index.md) | Search for products using query text and filters. |
| [`dev.ucp.shopping.catalog.lookup`](https://wry-ry.github.io/ucp/draft/specification/catalog/lookup/index.md) | Retrieve products or variants by identifier.      |
...
Environment data provided by the platform to support authorization and abuse prevention. Signal values MUST NOT be buyer-asserted claims. See [Signals](https://wry-ry.github.io/ucp/draft/specification/overview/#signals) for details and privacy requirements.
...
In lookup responses, each variant carries an `inputs` array for correlation: which request identifiers resolved to this variant, and whether the match was `exact` or `featured` (server-selected). See [Client Correlation](https://wry-ry.github.io/ucp/draft/specification/catalog/lookup/#client-correlation) for details.
...
Agents correlate results using the `inputs` array on each variant. See [Client Correlation](https://wry-ry.github.io/ucp/draft/specification/catalog/lookup/#client-correlation).
...
See [Warning Presentation](https://wry-ry.github.io/ucp/draft/specification/checkout/#warning-presentation) for the full rendering contract.
...
- [REST Binding](https://wry-ry.github.io/ucp/draft/specification/catalog/rest/index.md): RESTful API mapping.
- [MCP Binding](https://wry-ry.github.io/ucp/draft/specification/catalog/mcp/index.md): Model Context Protocol mapping via JSON-RPC.
