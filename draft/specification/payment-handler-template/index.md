...
The handler schema defines three config variants for different contexts. See [Payment Handler Guide: Defining the Schema](https://wry-ry.github.io/ucp/draft/specification/payment-handler-guide/#defining-the-schema) for the full pattern.
