...
**→ See [Payment Handler Guide](https://ucp.dev/2026-01-23/specification/payment-handler-guide/index.md)** for detailed guidance on handler structure, config/instrument/credential schemas, and the full specification template.
