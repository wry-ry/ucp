...
**→ [Payment Handler Template](https://wry-ry.github.io/ucp/2026-01-23/specification/payment-handler-template/index.md)**
...
| **Link to examples**            | Reference existing handler specs and the [Tokenization Guide](https://wry-ry.github.io/ucp/2026-01-23/specification/tokenization-guide/index.md) for common flows. |

______________________________________________________________________

## See Also

- **[Tokenization Guide](https://wry-ry.github.io/ucp/2026-01-23/specification/tokenization-guide/index.md)** — Guide for building tokenization payment handlers
