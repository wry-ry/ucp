...
| item      | [Item](/ucp/2026-01-23/specification/order/#item)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
| quantity  | object                                                       | **Yes**  | Quantity tracking. Both total and fulfilled are derived from events.                                                                                                       |
| totals    | Array\[[Total](/ucp/2026-01-23/specification/order/#total)\] | **Yes**  | Line item totals breakdown.                                                                                                                                                |
...
| destination    | [Postal Address](/ucp/2026-01-23/specification/order/#postal-address) | **Yes**  | Delivery destination address.                                                                               |
...
| Name | Type                                            | Required | Description |
| ---- | ----------------------------------------------- | -------- | ----------- |
| ucp  | [Ucp](/ucp/2026-01-23/specification/order/#ucp) | **Yes**  |             |
