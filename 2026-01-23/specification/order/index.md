...
| item      | [Item Response](/ucp/2026-01-23/specification/order/#item-response)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
| quantity  | object                                                                         | **Yes**  | Quantity tracking. Both total and fulfilled are derived from events.                                                                                                       |
| totals    | Array\[[Total Response](/ucp/2026-01-23/specification/order/#total-response)\] | **Yes**  | Line item totals breakdown.                                                                                                                                                |
