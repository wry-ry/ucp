...
| Name          | Type                                                                                            | Required | Description                                                                                                                                  |
| ------------- | ----------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [UCP Response Order Schema](/ucp/2026-01-23/specification/reference/#ucp-response-order-schema) | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                      |
...
| identity    | [Payment Identity](/ucp/2026-01-23/specification/reference/#payment-identity) | No       | The participant this token is bound to. Required when acting on behalf of another participant (e.g., agent tokenizing for merchant). Omit when the authenticated caller is the binding target. |
...
| billing_address | [Postal Address](/ucp/2026-01-23/specification/reference/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                     |
| credential      | [Payment Credential](/ucp/2026-01-23/specification/reference/#payment-credential) | No       | The base definition for any payment credential. Handlers define specific credential types.                                                                   |
...
| destination    | [Postal Address](/ucp/2026-01-23/specification/reference/#postal-address) | **Yes**  | Delivery destination address.                                                                               |
...
This object MUST be one of the following types: [Message Error](/ucp/2026-01-23/specification/reference/#message-error), [Message Warning](/ucp/2026-01-23/specification/reference/#message-warning), [Message Info](/ucp/2026-01-23/specification/reference/#message-info).
...
| Name                   | Type                                                                                      | Required | Description                                                |
| ---------------------- | ----------------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------- |
| merchant_authorization | [Merchant Authorization](/ucp/2026-01-23/specification/reference/#merchant-authorization) | No       | Merchant's signature proving checkout terms are authentic. |
