...
This document provides the detailed technical specification for UCP. For a complete definition of all data models and schemas, see the [Schema Reference](/ucp/latest/specification/reference/).
...
The following are examples of capabilities defined in UCP — see the [Specification](/ucp/latest/specification/overview/) for the authoritative and up-to-date list.
...
The following are examples of extensions defined in UCP — see the [Specification](/ucp/latest/specification/overview/) for the authoritative and up-to-date list.
...
See [Versioning](https://wry-ry.github.io/ucp/versioning/index.md) for the release branch process and the full breaking-change procedure.
