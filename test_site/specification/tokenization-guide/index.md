...
| Example                                                                                                      | Use Case                                            |
| ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| [Processor Tokenizer](https://ucp.dev/specification/examples/processor-tokenizer-payment-handler/index.md)   | Business or PSP runs tokenization and processing    |
| [Platform Tokenizer](https://ucp.dev/specification/examples/platform-tokenizer-payment-handler/index.md)     | Platform tokenizes credentials for businesses/PSPs  |
| [Encrypted Credential Handler](https://ucp.dev/specification/examples/encrypted-credential-handler/index.md) | Platform encrypts credentials instead of tokenizing |
...
- **[Encrypted Credential Handler](https://ucp.dev/specification/examples/encrypted-credential-handler/index.md)** — Alternative pattern using encryption instead of tokenize/detokenize round-trips
- **[AP2 Mandates Extension](https://ucp.dev/specification/ap2-mandates/index.md)** — Add cryptographic proof of checkout agreement for PSP verification
