...
The handler schema defines three config variants for different contexts. See [Payment Handler Guide: Defining the Schema](https://ucp.dev/specification/payment-handler-guide/#defining-the-schema) for the full pattern.
