...
| ------------ | ------------------------------------------------------------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Cart Schema](/specification/reference/#ucp-response-cart-schema) | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                            |
| id           | string                                                                         | **Yes**  | Unique cart identifier.                                                                                                                            |
| line_items   | Array\[[Line Item](/specification/reference/#line-item)\]                      | **Yes**  | Cart line items. Same structure as checkout. Full replacement on update.                                                                           |
| context      | [Context](/specification/reference/#context)                                   | No       | Buyer signals for localization (country, region, postal_code). Merchant uses for pricing, availability, currency. Falls back to geo-IP if omitted. |
| buyer        | [Buyer](/specification/reference/#buyer)                                       | No       | Optional buyer information for personalized estimates.                                                                                             |
| currency     | string                                                                         | **Yes**  | ISO 4217 currency code. Determined by merchant based on context or geo-IP.                                                                         |
| totals       | Array\[[Total](/specification/reference/#total)\]                              | **Yes**  | Estimated cost breakdown. May be partial if shipping/tax not yet calculable.                                                                       |
| messages     | Array\[[Message](/specification/reference/#message)\]                          | No       | Validation messages, warnings, or informational notices.                                                                                           |
| links        | Array\[[Link](/specification/reference/#link)\]                                | No       | Optional merchant links (policies, FAQs).                                                                                                          |
...
| totals       | Array\[[Total](/specification/reference/#total)\]                                      | **Yes**  | Different cart totals.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| payment      | [Payment](/specification/reference/#payment)                                           | No       | Payment configuration containing handlers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Name          | Type                                                                             | Required | Description                                                                                                                                  |
| ------------- | -------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [UCP Response Order Schema](/specification/reference/#ucp-response-order-schema) | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                      |
...
| totals        | Array\[[Total](/specification/reference/#total)\]                                | **Yes**  | Different totals for the order.                                                                                                              |
...
| credential      | [Payment Credential](/specification/reference/#payment-credential) | No       | The base definition for any payment credential. Handlers define specific credential types.                                                                   |
...
| Name              | Type                                                                                            | Required | Description                         |
| ----------------- | ----------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method](/specification/reference/#fulfillment-method)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method](/specification/reference/#fulfillment-available-method)\] | No       | Inventory availability hints.       |
...
This object MUST be one of the following types: [Shipping Destination](/specification/reference/#shipping-destination), [Retail Location](/specification/reference/#retail-location).
...
| options            | Array\[[Fulfillment Option](/specification/reference/#fulfillment-option)\] | No       | Available fulfillment options for this group.                          |
...
| destinations            | Array\[[Fulfillment Destination](/specification/reference/#fulfillment-destination)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                    | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group](/specification/reference/#fulfillment-group)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| totals                    | Array\[[Total](/specification/reference/#total)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| --------- | ------------------------------------------------- | -------- | ------------------------------------------------------ |
| id        | string                                            | **Yes**  |                                                        |
| item      | [Item](/specification/reference/#item)            | **Yes**  |                                                        |
| quantity  | integer                                           | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/specification/reference/#total)\] | **Yes**  | Line item totals breakdown.                            |
...
| code         | [Error Code](/specification/reference/#error-code) | **Yes**  | Error code identifying the type of error. Standard errors are defined in specification (see examples), and have standardized semantics; freeform codes are permitted.                                                                                                                                                                                                                                                                                                                                          |
...
| item      | [Item](/specification/reference/#item)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
